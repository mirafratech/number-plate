...
TRAIN_DIR = 'data_fold/train'
VAL_DIR = 'data_fold/val'
#TEST_DIR = 'data_fold/test'
TEST_DIR = 'LP_Images/test'
#TEST_DIR='/content/drive/MyDrive/CR_License_plate'

#CHECKPOINT_DIR = './checkpoint_4000'
#CHECKPOINT_DIR = './checkpoint2_4000'
...
def small_basic_block(inputdata, out_channel, name=None):
    with tf.variable_scope(name):
        ...
        conv2 = conv2d(relu1, out_div4, ksize=[1,3],pad='SAME', name='conv2')
        relu2 = tf.nn.relu(conv2)

        conv3 = conv2d(relu2, out_div4, ksize=[3,1],pad='SAME', name='conv3')
